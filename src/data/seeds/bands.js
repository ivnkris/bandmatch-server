const bands = [
  ...
  },
  {
    ...
    numberOfMembers: 4,
    instrument: ["guitar", "bass", "drums", "singer"],
    photo:
  ...
  },
  {
    ...
    numberOfMembers: 3,
    instrument: ["guitar", "singer", "keyboard"],
    photo:
  ...
  },
  {
    ...
    experienceLevel: "amateur",
    numberOfMembers: 4,
    instrument: ["guitar", "singer", "bass", "keyboard"],
    photo:
  ...
  },
  {
    ...
    description:
      "Nullam a dolor vitae ipsum pulvinar placerat. Cras malesuada, lectus et pharetra pharetra, nisl ante fermentum dui, vitae hendrerit odio mi ut neque. Aliquam vel justo accumsan, ultrices dolor non, lacinia velit. Mauris quis viverra ipsum, in mattis nunc. Nam et turpis lorem. Suspendisse elit mauris, suscipit id nisl id, vehicula congue ante. Pellentesque interdum ipsum eu aliquam cursus. Aliquam erat volutpat. Duis vitae ante vitae eros egestas iaculis id at ipsum. Vivamus at lorem viverra, elementum velit at, accumsan sapien.",
    soundCloud: "https://soundcloud.com/dc-jazz-jam",
    lookingFor: ["piano"],
    openToMembers: true,
  ...
  },
  {
    ...
    description:
      "Nullam a dolor vitae ipsum pulvinar placerat. Cras malesuada, lectus et pharetra pharetra, nisl ante fermentum dui, vitae hendrerit odio mi ut neque. Aliquam vel justo accumsan, ultrices dolor non, lacinia velit. Mauris quis viverra ipsum, in mattis nunc. Nam et turpis lorem. Suspendisse elit mauris, suscipit id nisl id, vehicula congue ante. Pellentesque interdum ipsum eu aliquam cursus. Aliquam erat volutpat. Duis vitae ante vitae eros egestas iaculis id at ipsum. Vivamus at lorem viverra, elementum velit at, accumsan sapien.",
    soundCloud: "https://soundcloud.com/grownfolk",
    lookingFor: ["singer"],
    openToMembers: true,
    openToCollaboration: false,
    favourites: [],
  ...
  },
  {
    ...
    experienceLevel: "expert",
    numberOfMembers: 3,
    instrument: ["guitar", "keyboard", "singer"],
    photo:
  ...
  },
  {
    ...
    bandName: "Chris and Sons",
    description:
      "Nullam a dolor vitae ipsum pulvinar placerat. Cras malesuada, lectus et pharetra pharetra, nisl ante fermentum dui, vitae hendrerit odio mi ut neque. Aliquam vel justo accumsan, ultrices dolor non, lacinia velit. Mauris quis viverra ipsum, in mattis nunc. Nam et turpis lorem. Suspendisse elit mauris, suscipit id nisl id, vehicula congue ante. Pellentesque interdum ipsum eu aliquam cursus. Aliquam erat volutpat. Duis vitae ante vitae eros egestas iaculis id at ipsum. Vivamus at lorem viverra, elementum velit at, accumsan sapien.",
    soundCloud: "https://soundcloud.com/thats-not-an-edit",
    lookingFor: ["drums"],
    openToMembers: true,
    openToCollaboration: false,
    favourites: [],
  ...
  },
  {
    ...
    experienceLevel: "amateur",
    numberOfMembers: 4,
    instrument: ["guitar", "singer", "drums", "keyboard"],
    photo:
